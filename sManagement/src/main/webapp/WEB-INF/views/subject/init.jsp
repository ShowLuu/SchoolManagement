...
<tr>
	<td>课程编号 :<input type="text" name="subID"/><input type="submit" name="delete" value="删除" /><input type="submit" name="byID" value="查找"/></td>
</tr>
<tr>
	<td>课程名称 :<input type="text" name="subName"/><input type="submit" name="likeQuery" value="模糊查询"/></td>
</tr>
<tr>
	<td>备注信息 :<input type="text" name="subRemark" /><input type="submit" name="likeQuery" value="模糊查询"/></td>
</tr>
</table>
<p align="center">
